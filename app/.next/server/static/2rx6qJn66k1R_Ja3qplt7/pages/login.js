...
__webpack_require__("1Xcz");

__webpack_require__("+y2F");
...
// EXTERNAL MODULE: ./layouts/layoutDesign.js + 2 modules
var layoutDesign = __webpack_require__("mCt1");

// EXTERNAL MODULE: ../node_modules/antd/lib/button/style/index.js
var style = __webpack_require__("tBtl");
...
var form_style = __webpack_require__("WZS7");
...
var input_style = __webpack_require__("RllP");
...
// CONCATENATED MODULE: ./components/AuthenticationForm.js
...
var AuthenticationForm_RegisterFields = function RegisterFields(props) {
  return external_react_default.a.createElement(form_default.a.Item, null, "Email:", props.getFieldDecorator("email", {
    rules: [{
      required: true,
...
var AuthenticationForm_AuthenticationForm =
/*#__PURE__*/
function (_Component) {
  Object(inherits["a" /* default */])(AuthenticationForm, _Component);

  function AuthenticationForm(props) {
    var _this;

    Object(classCallCheck["a" /* default */])(this, AuthenticationForm);

    _this = Object(possibleConstructorReturn["a" /* default */])(this, Object(getPrototypeOf["a" /* default */])(AuthenticationForm).call(this, props));

    Object(defineProperty["a" /* default */])(Object(assertThisInitialized["a" /* default */])(_this), "handleSubmit", function (e) {
      e.preventDefault();

      _this.props.form.validateFields(function (err, values) {
        external_isomorphic_unfetch_default()(_this.vManager.path, {
          method: "post",
          headers: {
            Accpet: "application/json",
            "Content-Type": "application/json"
          },
          body: stringify_default()(values)
        }).then(function (res) {
          return res.json();
        }).then(function (data) {
          if (data.token) {
            Object(LoginGate["b" /* login */])(data.token);
            router_default.a.push('/project');
          }
    ...
    if (_this.props.view === "login") _this.vManager = _this.view.login;else _this.vManager = _this.view.register;
    return _this;
  }

  Object(createClass["a" /* default */])(AuthenticationForm, [{
    key: "render",
    value: function render() {
      ...
      return external_react_default.a.createElement("div", null, external_react_default.a.createElement(form_default.a, {
      ...
      }, this.state.success && external_react_default.a.createElement("p", null, " ", this.vManager.name, " successful!"), this.state.error && external_react_default.a.createElement("p", null, this.vManager.name, " ERROR!"), external_react_default.a.createElement(form_default.a.Item, null, "Username:", getFieldDecorator("username", {
        rules: [{
          required: true,
      ...
      }))), external_react_default.a.createElement(form_default.a.Item, null, "Password:", getFieldDecorator("password", {
        rules: [{
          required: true,
      ...
      }))), this.props.view === "register" && external_react_default.a.createElement(AuthenticationForm_RegisterFields, {
        ...
        type: "primary",
        htmlType: "submit"
      }, this.vManager.name))), external_react_default.a.createElement("p", null, "If you don't have account, please contact admin."));
    }
  }]);
...
/* harmony default export */ var components_AuthenticationForm = (form_default.a.create({
  name: "authForm"
})(AuthenticationForm_AuthenticationForm));
// CONCATENATED MODULE: ./pages/login/index.js




var login_PageLogin = function PageLogin(props) {
  console.log(props, props);
  return external_react_default.a.createElement(layoutDesign["a" /* default */], null, external_react_default.a.createElement("div", null, external_react_default.a.createElement("h1", null, "Welcome to Bridge5 Asia Database Management"), external_react_default.a.createElement(components_AuthenticationForm, {
    view: "login"
  })));
};

/* harmony default export */ var login = __webpack_exports__["default"] = (login_PageLogin);
